...
export default function generateStupidName(generator = Math.random) {
...
export function randomNoun(generator = Math.random) {
  return nouns[Math.floor(generator() * nouns.length)];
}

export function randomAdjective(generator = Math.random) {
  return adjectives[Math.floor(generator() * adjectives.length)];
}

export function test (){
    return 'just a test, nothing to worry about!';
}