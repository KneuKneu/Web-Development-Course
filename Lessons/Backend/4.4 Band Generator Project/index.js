...
app.post("/submit", (req, res) => {
  const randomNumberAdj = Math.floor(Math.random() * adj.length);
  const randomNumberNoun = Math.floor(Math.random() * noun.length);

  // console.log(randomNumberAdj);
  res.render("index.ejs", { adj: capitalizeFirstLetter(adj[randomNumberAdj]), noun: capitalizeFirstLetter(noun[randomNumberNoun]) });
